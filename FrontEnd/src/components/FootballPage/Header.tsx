  ...
  const handleSearch = async () => {
    ...
    try {
      ...
      const filteredData = processedData.filter((match: ApiMatch) => {
        ...
        const matchesCategory = match.category === "Football";
        console.log(
  ...
  return (
    <div>
      ...
      <div
        ...
        style={{
          backgroundImage: "url('/football.jpg')",
          backgroundSize: "cover",
          backgroundPosition: "center",
          padding: "100px 20px",
        }}
      >
        <h1 className="text-dark fw-bold pb-3">5-A-SIDE FOOTBALL</h1>
                ...
                <div className="row g-3">
                  <div className="col-md-12">
                    <input
                      ...
                      placeholder="I want to play football in..."
                      value={search}
