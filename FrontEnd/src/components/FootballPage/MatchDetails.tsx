...
import { sendMatchConfirmationEmail } from "../../services/EmailService";

emailjs.init("Vnktrn2jnTHA4-bEK");
...
const MatchDetails: React.FC = () => {
  ...
  const handleJoin = async () => {
    try {
      ...
      // Update player count and UI state
      ...
      // Send confirmation email to Andrei
      await sendMatchConfirmationEmail({
        to_email: "andrei.lucacel@gmail.com",
        match_date: match.day, // Ensure these properties exist or replace with appropriate values
        match_time: match.startDate,
