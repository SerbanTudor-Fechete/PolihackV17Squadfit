...
import { Match } from "./MatchesListBasket";
...
function Header({ onMatchesUpdate }: HeaderProps) {
  ...
  const formats = ["Mixed", "Mens", "Ladies"];
  const days = [
    "Monday",
    "Tuesday",
    "Wednesday",
  ...
  const handleSearch = async () => {
    ...
    try {
      ...
      const filteredData = processedData.filter((match: ApiMatch) => {
        // Only show football matches
        const matchesCategory = match.category === "Basketball";
        console.log(
  ...
  return (
    <div>
      ...
      >
        <h1 className="text-white fw-bold">5-A-SIDE Basketball</h1>
        <p className="text-white">Find the best basketball leagues near you!</p>
                ...
                <div className="row g-3">
                  <div className="col-md-12">
                    <input
                      ...
                      placeholder="I want to play basketball in..."
                      value={search}
