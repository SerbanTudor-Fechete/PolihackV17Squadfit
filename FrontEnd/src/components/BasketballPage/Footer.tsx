    ...
    <div className="row g-4">
      ...
      <div className="col-md-6 col-lg-3">
        ...
        <ul className="list-unstyled text-light">
          <li className="mb-2">• Ideal for those new to basketball</li>
          ...
          <div className="accordion" id="footerAccordion">
            <div className="accordion-item">
              ...
              >
                <div className="accordion-body">
                  <p>
                    Our basketball courts are available for both pickup games
                    and scheduled matches. Courts can be booked hourly or you
                    can join ongoing games.
                  </p>
                </div>
              </div>
            </div>
            <div className="accordion-item">
              ...
              >
                <div className="accordion-body">
                  <p>
                    Simply select a court and time slot that works for you. You
                    can register for pickup games or organize your own matches
                    with friends.
                  </p>
                </div>
              </div>
